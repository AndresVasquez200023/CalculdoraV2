...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button multitButton = findViewById(R.id.multi);

        multitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int multi = Integer.parseInt(valor1.getText().toString()) * Integer.parseInt(valor2.getText().toString()); // Cambiado de '+' a '-'
                Intent intent = new Intent(MainActivity.this, MainActivity2.class);
                intent.putExtra("resultado", multi);
                startActivity(intent);
            }
        });
